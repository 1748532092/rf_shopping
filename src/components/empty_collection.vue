<!--
 * @Author: your name
 * @Date: 2021-04-21 09:44:31
 * @LastEditTime: 2021-04-21 09:46:24
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \TinyShop-UniApp-based:\Desktop\rf_shopping\src\components\empty_collection.vue
-->
<template name="empty_collection">
  <view class="empty">
